...
abstract class BaseUsersPeer {
	...
	const CLASS_DEFAULT = 'blog.Users';
	...
	{
		include_once 'blog/map/UsersMapBuilder.php';
		return BasePeer::getMapBuilder('blog.map.UsersMapBuilder');
	}
	/**
	...
	{
		return $alias . substr($column, strlen(UsersPeer::TABLE_NAME));
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsersPeer::MAIL);
...
if (Propel::isInit()) {
	...
	require_once 'blog/map/UsersMapBuilder.php';
	Propel::registerMapBuilder('blog.map.UsersMapBuilder');
}
