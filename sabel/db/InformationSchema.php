...
class Sabel_DB_Schema
{
  ...
  public function __construct($connectName, $schema)
  {
    ...
    $className = 'Sabel_DB_' . $dbName . 'Schema';
...
class Sabel_DB_MysqlSchema extends Sabel_DB_MyPgSchema
{
...
class Sabel_DB_PgsqlSchema extends Sabel_DB_MyPgSchema
{
  public function getNumericTypes()
  {
