 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabel_Http_Response  /* Zend_Http_Response */
{
    /**
     ...
     *
     * In most cases, you would use Sabel_Http_Response::fromString to parse an HTTP
     * response string and create a new Sabel_Http_Response object.
     *
    ...
    public function __construct($code, $headers, $body = null, $version = '1.1', $message = null)
    {
        ...
        if (self::responseCodeAsText($code) === null) {
            throw new Sabel_Exception_Runtime("{$code} is not a valid HTTP response code");
        }
        ...
        if (! is_array($headers)) {
            throw new Sabel_Exception_Runtime('No valid headers were passed');
    }
        ...
        if (! preg_match('|^\d\.\d$|', $version)) {
            throw new Sabel_Exception_Runtime("Invalid HTTP response version: $version");
        }
    ...
    public static function decodeChunkedBody($body)
    {
        ...
        while (trim($body)) {
            if (! preg_match("/^([\da-fA-F]+)[^\r\n]*\r\n/sm", $body, $m)) {
                throw new Sabel_Exception_Runtime("Error parsing body - doesn't seem to be a chunked message");
            }
    ...
    public static function decodeGzip($body)
    {
        if (! function_exists('gzinflate')) {
            throw new Sabel_Exception_Runtime('Unable to decode gzipped response ' . 
    ...
    public static function decodeDeflate($body)
    {
        if (! function_exists('gzuncompress')) {
            throw new Sabel_Exception_Runtime('Unable to decode deflated response ' . 
                'body: perhaps the zlib extension is not loaded?'); 
        }
    ...
    /**
     * Create a new Sabel_Http_Response object from a string
     *
     * @param string $response_str
    ...
    public static function fromString($response_str)
    {
        ...
        return new Sabel_Http_Response($code, $headers, $body, $version, $message);
    }
}
