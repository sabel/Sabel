 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabel_Http_Cookie  /* Zend_Http_Cookie */
{
    /**
     * Cookie name
     *
    ...
    public function __construct($name, $value, $domain, $expires = null, $path = null, $secure = false)
    {
        ...
        if (! $this->name = (string) $name) {
            throw new Sabel_Exception_Runtime('Cookies must have a name');
        }

        if (! $this->domain = (string) $domain) {
            throw new Sabel_Exception_Runtime('Cookies must have a domain');
        }
    ...
    public static function fromString($cookieStr, $ref_uri = null)
    {
        ...
        if (is_string($ref_uri)) {
            $ref_uri = new Sabel_Http_Uri($ref_uri);
        }
        ...
        if ($name !== '') {
            return new Sabel_Http_Cookie($name, $value, $domain, $expires, $path, $secure);
        } else {
            return false;
        }
    }
